export const Projects_Data = [
   { 
    ...
    { 
      ...
      introHeading1:
        "With Nuegas, users can create tasks, assign them to team members, and set deadlines. The app also includes features such as categorization, prioritization, and task dependencies to help users stay focused and manage their workload effectively.",
      introSubheading:
        " It acted as a guide to my learning path and altered my views of design and development",
      ...
      paragraph2text:
        "Functional Programming, System Design, Information Architecture,Testing",
      paragraph3text: "ReactJS, Material UI, GSAP,Firebase,Strapi ,Vercel",
      paragraph4text:
        " The Purpose of this Project was to build a functional and aesthetically  pleasing frontend to help users manage their crypto assets",
      paragraph5text:
      ...
      paragraph6text:
        "In addition to individual task management, Nuegas includes collaboration features that allow teams to work together on projects and assignments. Users can create shared task lists and assign tasks to team members, as well as communicate with one another through the app's built-in messaging system.  Overall, Nuegas is a powerful and flexible task management solution that helps users stay organized, prioritize their work, and collaborate with their team.",
