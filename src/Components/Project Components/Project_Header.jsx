...
<Grid xs={12}   height={query ? '20rem':'15rem'} textAlign='center' container direction='column'  alignItems='center' gap='1rem' justifyContent='center' className='portolio_project_header_text'>
<h1 className='portfolio_projects_header' ref={el => headerEl = el}>{Title}</h1>
<p>{subTitle}</p>
</Grid>

<Grid   xs={12} height={query ? '10rem':'' } container alignItems={query ? 'flex-start':'center'} justifyContent='center' className='portolio_project_header_description'>
